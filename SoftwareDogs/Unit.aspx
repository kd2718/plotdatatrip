<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Unit.aspx.cs" Inherits="SoftwareDogs.Unit" %>

<!DOCUnit html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<body bgcolor="#A1DAEC">
    ...
    <p class="style3">
        <asp:GridView ID="gData" runat="server" AllowPaging="True" AllowSorting="True" 
            AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataKeyNames="iUnitKey,acName,iUnitNumber,iDepartmentKey,Deletable" 
            ...
            <Columns>
                <asp:BoundField DataField="iUnitKey" HeaderText="Unit Key" />
                <asp:BoundField DataField="acName" HeaderText="Name" />
                <asp:BoundField DataField="iUnitNumber" HeaderText="Unit Number" />
                <asp:BoundField DataField="iDepartmentKey" HeaderText="Department" />
                <asp:BoundField DataField="Deletable" HeaderText="Deletable" />
                <asp:ButtonField ButtonType="Button" Text="Department" />
            </Columns>
